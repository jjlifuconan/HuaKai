package com.social.basecommon.widget;
...
//        Log.d("Drawable size" + compoundDrawables.length + "value = " + compoundDrawables + "");
...
//            Log.d("width/height" + drawable.getIntrinsicWidth() + "," + drawable.getIntrinsicHeight());
//            Log.d("scale = %s", scale);
            drawable.setBounds(0, 0, width, height);
            Rect bounds = drawable.getBounds();
            //高宽只给一个值时，自适应
            if (bounds.right != 0 || bounds.bottom != 0) {
//                Log.d("before" + bounds.right + "," + bounds.bottom);
                if (bounds.right == 0) {
...
//                Log.d("after" + bounds.right + "," + bounds.bottom);
            }
