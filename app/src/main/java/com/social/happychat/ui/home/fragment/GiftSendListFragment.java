 ...
 * @description:礼物列表
 */
public class GiftSendListFragment extends BaseFragment<FragmentRefreshListBinding> implements GiftShopNavigator {
    private GiftSendReceiveAdapter GiftAdapter;
    private GiftShopPresent present;

    public static GiftSendListFragment newInstance() {

        Bundle args = new Bundle();

        GiftSendListFragment fragment = new GiftSendListFragment();
