...
import com.social.happychat.ui.home.fragment.GiftSendReceiveListFragment;
...
public class GiftShopActivity extends BaseCookieActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(getIntent().getIntExtra("type", GiftShopActivity.TYPE_SHOP) == GiftShopActivity.TYPE_SHOP){
            ...
            loadRootFragment(R.id.content, GiftSendReceiveListFragment.newInstance((ArrayList<UserBean.GiftListBean>) getIntent().getSerializableExtra("giftListBeanList")));
