...
public class GiftRecordViewModel {
    ...
    public void setData(int page, int per_page, int channel, int dynamicId, int userId) {
        this.page = page;
    ...
    public void getGiftData(final RequestImpl listener) {
        ...
        if(channel == Constant.SendGiftType.TREND){
            map.put("dynamicId",dynamicId);
        }else if(channel == Constant.SendGiftType.USER_HOME){
