package com.social.happychat.widget.bottombarTitle;
...
public class BottomBarTab extends FrameLayout {
    ...
    public BottomBarTab(Context context, @DrawableRes int defaultIcon, @DrawableRes int selectIcon, CharSequence title) {
        this(context, null,0, defaultIcon, selectIcon, title);
    }

    public BottomBarTab(Context context, AttributeSet attrs, int defStyleAttr, int defaultIcon, int selectIcon, CharSequence title) {
    ...
    private void init(Context context, int defaultIcon, CharSequence title) {
        mContext = context;
    ...
    public void changeIconAndText(@DrawableRes int defaultIcon, @DrawableRes int selectIcon, CharSequence title){
        this.defaultIcon = defaultIcon;
        this.selectIcon = selectIcon;
        mTvTitle.setText(title);
        setSelected(true);
