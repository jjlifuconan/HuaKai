...
//        Subscription subscription = HttpClient.Builder.getGankIOServer().getPraiseData(id, page, per_page)
...
//                });
        ...
        PraiseListBean bean = new GsonBuilder().serializeNulls().create().fromJson(sss, PraiseListBean.class);
